...
## RAW SQL USED FOR DB POPULATION:
INSERT INTO public.tbl_zhamshid_clean_jobs (id, title, company, location, link, source, date_posted, work_type, employment_type, description)
VALUES
